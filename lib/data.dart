...
class preciosBebidas{
  ...
  static Product pint = Product("Pinta", 3, "assets/img/pinta.png");
  static Product radler = Product("Radler", 2.0, "assets/img/radler.png");
  static Product kali = Product("Kalimotxo", 3.5, "assets/img/kali.png");
  static Product drink = Product("Cubata", 5.0, "assets/img/cubata.png");
  static Product bigCupKali = Product("Katxi Kalimocho", 7.0, "assets/img/katxi.png");
  static Product bigCupCerve = Product("Katxi Cerveza", 6.0, "assets/img/katxi.png");
  ...
  static List<Product> bebidas = [water, beer, shot, drink, frosty, kali, bigCupCerve, bigCupDrink, bigCupKali, marianito, mosto, pint, radler, soda, vermouth, wine];
}
